...
pub struct MessageDescriptor {
    ...
    /// The fully qualified protobuf type name (e.g., "bubbaloop.header.v1.Header")
...
///
/// ```rust,no_run
/// use bubbaloop::{get_descriptor_for_message, Header};
///
/// let descriptor = get_descriptor_for_message::<Header>()?;
