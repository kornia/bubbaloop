...
pub mod schemas {
    ...
    pub mod recorder {
        pub mod v1 {
            include!(concat!(env!("OUT_DIR"), "/bubbaloop.recorder.v1.rs"));
        }
    }
...
/// Service definitions for ros-z
pub mod services {
    /// Recording service types
    pub mod recording {
        use ros_z::msg::ZService;
        use ros_z::{ServiceTypeInfo, TypeHash};

        /// Protobuf schemas for recording service
        pub mod schemas {
            pub use crate::schemas::recorder::v1::{
                StartRecordingRequest, StartRecordingResponse, StopRecordingRequest,
                StopRecordingResponse,
            };
        }

        /// Service type for starting recording
        pub struct StartRecording;

        impl ZService for StartRecording {
            type Request = schemas::StartRecordingRequest;
            type Response = schemas::StartRecordingResponse;
        }

        impl ServiceTypeInfo for StartRecording {
            fn service_type_info() -> ros_z::entity::TypeInfo {
                ros_z::entity::TypeInfo::new(
                    "bubbaloop.recorder.v1.StartRecording",
                    TypeHash::zero(),
                )
            }
        }

        /// Service type for stopping recording
        pub struct StopRecording;

        impl ZService for StopRecording {
            type Request = schemas::StopRecordingRequest;
            type Response = schemas::StopRecordingResponse;
        }

        impl ServiceTypeInfo for StopRecording {
            fn service_type_info() -> ros_z::entity::TypeInfo {
                ros_z::entity::TypeInfo::new(
                    "bubbaloop.recorder.v1.StopRecording",
                    TypeHash::zero(),
                )
            }
        }
...
// Recorder service message type implementations
impl MessageTypeInfo for services::recording::schemas::StartRecordingRequest {
    fn type_name() -> &'static str {
        "bubbaloop.recorder.v1.StartRecordingRequest"
    }
...
impl WithTypeInfo for services::recording::schemas::StartRecordingRequest {}

impl MessageTypeInfo for services::recording::schemas::StartRecordingResponse {
    fn type_name() -> &'static str {
        "bubbaloop.recorder.v1.StartRecordingResponse"
    }
...
impl WithTypeInfo for services::recording::schemas::StartRecordingResponse {}

impl MessageTypeInfo for services::recording::schemas::StopRecordingRequest {
    fn type_name() -> &'static str {
        "bubbaloop.recorder.v1.StopRecordingRequest"
    }
...
impl WithTypeInfo for services::recording::schemas::StopRecordingRequest {}

impl MessageTypeInfo for services::recording::schemas::StopRecordingResponse {
    fn type_name() -> &'static str {
        "bubbaloop.recorder.v1.StopRecordingResponse"
    }
...
impl WithTypeInfo for services::recording::schemas::StopRecordingResponse {}
